...
def load_topic_vector_file(data_dir="data"):
    try:
        with open(data_dir+"/topic_vectors.json", "r") as f:
...
def save_topic_vector_file(topic_vectors, data_dir="data"):
    with open(data_dir+"/topic_vectors.json", "w") as f:
