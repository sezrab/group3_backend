    ...
    def get_read_articles(self, user_id):
        try:
            return (
                ...
                .get()
                .to_dict()["readArticles"]
            )
        except:
            return {}

    def get_selected_sources(self, user_id, default=[]):
...
class FirebaseUser:
    ...
    def get_selected_sources(self):
        s = self._fb.get_selected_sources(self._user_id)
        if s == []:
            s = ["Arxiv", "Semantic Scholar", "ACL Anthology"]
        return s
